...
<body>
	...
	<form id="all" action="/announce/modifyAnnounce" method="post" >
	<div id="box">
		<div class="form-group">
			<input type="hidden"  name="post_code" value="${announcespecificcontent.post_code}">
			<label for="exampleInputEmail1">제목</label>
			<textarea name="post_title" class="form-control" id="exampleFormControlTextarea1"
				rows="1"> ${announcespecificcontent.post_title} </textarea>
		</div>
		<div class="form-group">
			<label for="exampleFormControlTextarea1">내용</label>
			<textarea name="post_content" class="form-control" id="exampleFormControlTextarea1"
				rows="12">${announcespecificcontent.post_content} </textarea>
		</div>
