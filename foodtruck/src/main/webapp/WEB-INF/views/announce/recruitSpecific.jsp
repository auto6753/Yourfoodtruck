   ...
   <div style="height: 800px;">
      ...
      <div id="content" style="display: inline-block;">
         <div id="box">
               ...
               <input id="ddd" style="margin:0; float:right; margin-right:20%;" class="btn" value="목록">
               
               <c:if test="${sessionScope.sessionid.email == specific.request_email}">
               <input id="delete" style="margin:0; margin-right:10px; float:right;" type="button" class="btn" value="삭제">
