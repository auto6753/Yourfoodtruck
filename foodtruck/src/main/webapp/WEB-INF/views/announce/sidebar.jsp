...
<body>
	...
	<div class="list-group">
				<ul class="sidebar">
					<li class="menu" ><a href="#"  class="list-group-item"><i class="fa fa-credit-card"></i> <span style="font-family: 'Hanna', serif;">지자체 모집공고</span></a>
					<li class="menu"><a href="#"   class="list-group-item"><i class="fa fa-credit-card"></i> <span style="font-family: 'Hanna', serif;">일반 모집공고</span></a>
