...
<link rel="stylesheet" href="<c:url value="/resources/css/news/addNews.css"/>" />
	...
	<form id="all" action="/news/addNews" method="post" onsubmit="return ck();" onreset="historyBack();">
		<div id="box">
			<div class="form-group">
				<label for="exampleInputEmail1">제목</label> <input name="post_title"
					id="titles" type="text" class="form-control">
			</div>
			<div class="form-group">
