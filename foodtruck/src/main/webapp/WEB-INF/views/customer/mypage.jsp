...
<div>
	<div id="title" class="col">
		...
		<button id="container3" class="text review col btn btn-default" ><h4>리뷰 및 평점</h4><img src="/resources/image/review.svg" class="img2"></button>
	...
	<div id="title2" class="col">
		<button id="container2" class="text2 cusInfo col btn btn-default"><h4>회원 정보 관리</h4><img src="/resources/image/cusInfo.svg" class="img1"></button>
		<button id="container2" class="text2 col myQuestion btn btn-default"><h4>1:1문의 내역</h4><img src="/resources/image/myQuestion.svg" class="img1"></button>
