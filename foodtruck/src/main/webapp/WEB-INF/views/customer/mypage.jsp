...
<link rel="stylesheet" href="resources/css/customercss/customercss.css">
<link rel="stylesheet"
		...
		<a class="portfolio-link" data-toggle="modal" href="">
			<div class="portfolio-hover">
				<div class="portfolio-hover-content">
					<i class="fas fa-plus fa-3x"> ::before </i>
				</div>
			</div> <img class="img-fluid" src="img/protfolio/01-thumbnail.jpg" alt>
		</a>
