...
<link rel="stylesheet"
	href="<c:url value ="/resources/css/customercss/goodbyeForm.css"/>" />
<script>
	$(document).ready(function() {
		$(".goodbye").click(function() {
			location.href = "/customer/goodbye";
		});
	});
</script>
			...
			<div class="col-md-10">
				<div id="with" class="col">
					...
					<div id="check" class="col">
						...
						<input id="box" type="checkbox">단순변심&nbsp;&nbsp;&nbsp; <input
							id="box" type="checkbox">자주이용하지않음&nbsp;&nbsp;&nbsp;&nbsp;
						<input id="box" type="checkbox">개인정보/사생활 침해 사례경험<br>
						<input id="box" type="checkbox">찾고자하는 정보가
						없음&nbsp;&nbsp;&nbsp; <input id="box" type="checkbox">기타&nbsp;<input
							id="radius">
					</div>
					<div class="goodbye">
