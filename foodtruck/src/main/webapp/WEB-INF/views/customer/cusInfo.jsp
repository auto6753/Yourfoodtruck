		...
		<div class="div2 col">
			...
			<div class="dim-layer">
				...
				<div id="layer2" class="pop-layer">
					<div class="pop-container">
						<div class="pop-conts">
							닉네임:${cusinfo.nickname}<br> <input placeholder="변경닉네임" id="nickname"> <br>
							<p>사용할 닉네임을 입력해주세요.</p>
							<br> <br>
							<div class="btn-r">
								<a type="button"  class="btn-layerClose" id="button1">변경</a>
								<a type="button"  class="btn-layerClose" id="button2">취소</a>
							</div>
						</div>
					</div>
				</div>
