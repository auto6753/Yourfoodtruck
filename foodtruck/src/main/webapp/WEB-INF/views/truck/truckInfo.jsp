...
<body>
	...
	<div id="height" class="col">
		...
		<div id="location" style="visibility: hidden;">
			...
			<script>
				...
				mapOption = {
					center : new daum.maps.LatLng(35.8965788, 128.6202353), // 지도의 중심좌표
					level : 3
				// 지도의 확대 레벨
				};
				...
				// 마커가 표시될 위치입니다 
				var markerPosition = new daum.maps.LatLng(35.8965788,
						128.6202353);
	...
	<script>
		var markerPosition = new daum.maps.LatLng(35.8965788, 128.6202353);
		...
		staticMapOption = {
			center : new daum.maps.LatLng(35.8965788, 128.6202353), // 이미지 지도의 중심좌표
